...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../Lab1.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001058
SOPC_SYSID_FLAG += --sidp=0x8001058
ELF_PATCH_FLAG  += --sidp 0x8001058

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1696670962
SOPC_SYSID_FLAG += --timestamp=1696670962
ELF_PATCH_FLAG  += --timestamp 1696670962
