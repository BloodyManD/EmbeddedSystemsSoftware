...
# Memory: instruction_tcm
MEM_0 := niosII_instruction_tcm
$(MEM_0)_NAME := instruction_tcm
...
$(MEM_0)_END := 0x10003fff
$(MEM_0)_SPAN := 0x00004000
$(MEM_0)_HIERARCHICAL_PATH := instruction_tcm
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: instruction_tcm
instruction_tcm: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
